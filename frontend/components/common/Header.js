    ...
    <>
      ...
      <header className="header">
        <div className="container">
          <div className="header__wrapper">
            ...
            <div className="header__left">
              ...
              <div className="header__content">
                <Search isAdmin={props.profile.userInfo.isAdmin}/>
            ...
            <div className="header__right">
              ...
              {!!props.profile.userInfo.isAdmin && (
          ...
          <Search addClass="mobile" isAdmin={props.profile.userInfo.isAdmin} />
        </div>
      </header>
      <Link
        className={
          props.cart.quantity && router.asPath === '/'
            ? 'active cart-button'
            : 'cart-button'
        }
        href="/cart"
