  ...
  return props.cart.quantity ? (
    <>
      ...
      <section className="cart-products">
        <div className="container">
          <h2 className="cart-products__title">Products in cart</h2>
      ...
      {!!props.cart.popularItems && (
        <section className="cart-add">
          <div className="container">
            <h2 className="cart-add__title">Add to order</h2>
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    getPopularItems: (allProducts, cartProducts) =>
      dispatch(getPopularItems(allProducts, cartProducts)),
  };
};
